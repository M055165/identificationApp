...
import 'dart:ui';
import 'package:bamboo/UI/cameraPage.dart';
import 'package:bamboo/utils/text_styles.dart';
import 'package:bamboo/utils/ui_helpers.dart';
import 'package:bamboo/widgets/sexy_tile.dart';
...
class _SexyBottomSheetState extends State<SexyBottomSheet>
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        new IconButton(
                          ...
                          iconSize: 60.0,
                          icon: new Image.asset('images/icon-legacy01.png',),
                          onPressed: () {
                        ...
                        new IconButton(
                          iconSize: 60.0,
                          padding: new EdgeInsets.all(10.0),
                          icon: new Image.asset('images/icon-legacy02.png',),
                        ),
                        new IconButton(
                          iconSize: 60.0,
                          padding: new EdgeInsets.all(10.0),
                          icon: new Image.asset('images/icon-legacy03.png',),
                          onPressed: () {
                        ...
                        new IconButton(
                          iconSize: 60.0,
                          padding: new EdgeInsets.all(10.0),
                          icon: new Image.asset('images/icon-legacy04.png',),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget buildIcon1(BuildContext context) {
    return ImageButton(
      children: <Widget>[],
      width: 91,
      height: 36,
...
final List<SheetItem> items = [
  SheetItem('assets/icon/icon-legacy01.png', 'Icon 1'),
  SheetItem('assets/icon/icon-legacy02.png', 'Icon 2'),
  SheetItem('assets/icon/icon-legacy03.png', 'Icon 3'),
  SheetItem('assets/icon/icon-legacy04.png', 'Icon 4'),
];
